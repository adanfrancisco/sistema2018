...
*/
//echo $options; 
$consultacurso="select carrera_nombre,descripcion, materia, materia_nombre ,grupo, profesor, profesores.apellido,profesores.nombre , reemplazo from mat_pro_novedades 
        ...
        if ($resultado = $con->query($consultacurso))
         {
            ...
            {
                $options='<option value="'.$fila['materia'].'"> '.$fila['materia_nombre'].'</option>';
                echo $options;  
            }
        }      
