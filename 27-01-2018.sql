...
(11222333, 0, 'GONZALEZ', 'JUAN', '17/11/1988', '1', 17, 'YAPEYU 54', '777', '888', 'mimail@gmail.com', '7', 132, 24, 1);
...
CREATE TABLE `mat_cl_superior` (
  `idmatclsuperior` int(100) NOT NULL,
  `materia` int(3) NOT NULL,
  `alumno` int(8) NOT NULL,
  `curso_lectivo` int(3) NOT NULL,
  `division` int(3) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(25108642, 0, 'MACHUCA', 'OSCAR', 1, '9 DE JULIO 673', 17, '02225484693', '0222415464510', 30, '04/04/1976', '', '', 30, '', NULL),
...
(28054020, 0, 'PINI', 'LEANDRO ALEXIS', 1, '', 18, '', '1136884366', 31, '21/06/1980', '', '', 24, '', NULL),
...
(36, 23618812, 'D', '13-01-2018', 24, '2018-01-13 23:52:39'),
(37, 23618812, 'DD', '15-01-2018', 24, '2018-01-15 16:58:17'),
(38, 23618812, 'DD', '15-01-2018', 24, '2018-01-15 16:59:38'),
(39, 23618812, 'JAJAJA', '26-01-2018', 30, '2018-01-26 13:53:02'),
(40, 23618812, 'SSSSAAAA', '26-01-2018', 24, '2018-01-26 13:56:12');
...
ALTER TABLE `mat_cl_superior`
  ADD PRIMARY KEY (`idmatclsuperior`);
...
ALTER TABLE `mat_cl_superior`
  MODIFY `idmatclsuperior` int(100) NOT NULL AUTO_INCREMENT;
ALTER TABLE `mat_pro`
  MODIFY `id_matpro` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
ALTER TABLE `mat_pro_novedades`
  MODIFY `id_matpro_novedades` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
ALTER TABLE `parametros`
  MODIFY `idParam` int(10) NOT NULL AUTO_INCREMENT;
ALTER TABLE `profe_notas`
  MODIFY `id_nota` int(4) NOT NULL AUTO_INCREMENT;
ALTER TABLE `profe_novedad`
  MODIFY `idnovedad` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
ALTER TABLE `profe_tipo`
...
ALTER TABLE `usuarios`
  MODIFY `usuario_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
