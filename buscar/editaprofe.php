...
<input name="domicilio" id="domicilio"class="input-text align-center" style="padding: 0; width: 260px" type="text" id="clave" value="<?=$domicilio ?>" maxlength="10" placeholder="DOMICILIO CALLE NRO" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" ;">
